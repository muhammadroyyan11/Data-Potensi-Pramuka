    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="<?= site_url('dashboard') ?>">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <?php if (userdata('role') == 1) { ?>
                    ...
                    <li <?= $this->uri->segment(1) == 'about' ? 'class="active nav-item"' : 'nav-item' ?>><a href="<?= site_url('about') ?>"><i class="feather icon-save"></i><span class="menu-title" data-i18n="Laporan">Atur About</span></a>
                    </li>
